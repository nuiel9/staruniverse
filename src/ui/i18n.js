...
const STRINGS = {
  ...
  /* ------------------------------------------------ on the ground, in play
     ...
     rover was built and stayed that way — which is most of what a player sees
     while driving, so a Thai game read as English the moment it got moving. */
  'g.roverOut': ['ROVER DEPLOYED · WASD TO DRIVE · R TO STOW',
    'นำยานสำรวจออกแล้ว · WASD เพื่อขับ · R เพื่อเก็บ'],
  'g.roverStowed': ['ROVER STOWED · PACK RECHARGED', 'เก็บยานสำรวจแล้ว · ชาร์จพลังงานเต็ม'],
  'g.tooFarStow': ['TOO FAR FROM THE SHIP TO STOW', 'อยู่ไกลจากยานเกินกว่าจะเก็บได้'],
  'g.transferred': ['%N t TRANSFERRED TO THE HOLD', 'ย้ายเข้าระวางแล้ว %N ตัน'],
  'g.leftBehind': ['%N t LEFT BEHIND · HOLD FULL', 'ทิ้งไว้ %N ตัน · ระวางเต็ม'],
  'g.seamHere': ['%S SEAM · %N t · HOLD F', 'สายแร่ %S · %N ตัน · กด F ค้าง'],
  'g.seamOut': ['%S SEAM · WORKED OUT', 'สายแร่ %S · ขุดหมดแล้ว'],
  'g.alreadyWorked': ['%S · ALREADY WORKED', '%S · สำรวจไปแล้ว'],
  'g.eBoard': ['%S · E TO BOARD', '%S · กด E เพื่อขึ้นสำรวจ'],
  'g.eSurvey': ['%S · E TO SURVEY', '%S · กด E เพื่อสำรวจ'],
  'g.eAnswer': ['%S · E TO ANSWER', '%S · กด E เพื่อตอบรับ'],
  'g.nothingHere': ['NOTHING HERE', 'ไม่มีอะไรตรงนี้'],
  'g.holdFHere': ['HOLD F TO WORK THE SEAM', 'กด F ค้างไว้เพื่อขุดสายแร่'],
  'g.alreadyDone': ['ALREADY WORKED', 'สำรวจไปแล้ว'],
  'g.logRecovered': ['LOG RECOVERED · FILED TO THE ARCHIVE', 'กู้บันทึกได้ · จัดเก็บเข้าคลังข้อมูลแล้ว'],
  'g.markerDone': ['MARKER SURVEYED · %N ON RECORD', 'สำรวจเครื่องหมายแล้ว · มีบันทึกไว้ %N แห่ง'],
  'g.accountFiled': ['ACCOUNT FILED · A SECOND SOURCE', 'บันทึกคำบอกเล่าแล้ว · เป็นแหล่งที่สอง'],
  'g.who.salvage': ['SALVAGE', 'การกู้ซาก'],
  'g.who.marker': ['HUSH MARKER', 'เครื่องหมายของชาวฮัช'],
  'g.who.survivor': ['SURVIVOR', 'ผู้รอดชีวิต'],
  'g.narr.wreck': ['The %S came out here a century before you did and never left. The log is still readable.',
    'ยาน %S ออกมาที่นี่ก่อนคุณหนึ่งศตวรรษ และไม่เคยได้กลับ บันทึกของมันยังอ่านได้อยู่'],
  'g.narr.marker': ['It is not a monument and it is not a grave. It is tuned — and it is tuned to the same phase the Tines are.',
    'มันไม่ใช่อนุสรณ์ และไม่ใช่หลุมศพ มันถูกตั้งเสียงไว้ — และตั้งไว้ที่เฟสเดียวกับเครื่องกำธร'],
  'g.narr.survivor': ['%S has been down here nineteen years and is in no hurry. "They are not dead," they say. "I have been listening to them the whole time."',
    '%S อยู่ข้างล่างนี่มาสิบเก้าปีแล้ว และไม่ได้รีบร้อนอะไร "พวกเขาไม่ได้ตาย" เขาบอก "ผมฟังพวกเขามาตลอด"'],
  'g.seamSpent': ['SEAM SPENT', 'สายแร่หมดแล้ว'],
  'g.noSeamHere': ['NO SEAM HERE · DRIVE TO ONE', 'ตรงนี้ไม่มีสายแร่ · ขับไปยังจุดที่มี'],
  'g.seamsExhausted': ['SEAMS EXHAUSTED HERE', 'สายแร่ที่นี่ถูกขุดหมดแล้ว'],
  'g.nothingToDrill': ['NOTHING WORTH DRILLING HERE', 'ที่นี่ไม่มีอะไรคุ้มค่าจะขุด'],
  'g.holdFull': ['HOLD FULL', 'ระวางเต็ม'],
  'g.binFull': ['ROVER BIN FULL · RETURN TO THE SHIP', 'ถังยานสำรวจเต็ม · กลับไปที่ยาน'],
  'g.lucentGot': ['LUCENT +1 · TANK %A/%B', 'ลูเซนต์ +1 · ถัง %A/%B'],
  'g.oreGot': ['%S +1 t · seam %N t', '%S +1 ตัน · เหลือ %N ตัน'],
  'g.noBerthDerelict': ['DERELICT · NO BERTH ANSWERS', 'ซากสถานีร้าง · ไม่มีท่าจอดตอบรับ'],
  'g.noBerthWreck': ['WRECKAGE · NOTHING TO DOCK WITH', 'ซากยาน · ไม่มีอะไรให้เทียบท่า'],
  'g.noBerthTine': ['TINE · SCAN IT, YOU CANNOT BERTH ON IT', 'เครื่องกำธร · สแกนได้ แต่เทียบท่าไม่ได้'],
  'g.noBerthOther': ['NOTHING HERE TAKES A LINE', 'ที่นี่ไม่มีอะไรให้ผูกเชือก'],
  'g.noBerthRange': ['NO BERTH IN RANGE · %S %D', 'ไม่มีท่าจอดในระยะ · %S %D'],
  'g.noBerthNone': ['NO BERTH IN RANGE', 'ไม่มีท่าจอดในระยะ'],
